...
Schiedsgerichten](/wiki/Bundesschiedsgericht.md).
...
Geschäftsordnung](/wiki/Go_Schiedsgericht.md). Diese enthält
...
(1) Die [ Bundesgesamtkonferenz](/wiki/Bundesgesamtkonferenz.md) wählt
drei Mitglieder zu Richtern. Diese wählen aus ihren Reihen einen
Vorsitzenden Richter, der das [
Schiedsgericht](/wiki/Bundesschiedsgericht.md) leitet und die
Geschäfte führt.
...
(3) Die Zahl der zu wählenden Richter und Ersatzrichter kann durch
...
(4) Das Gericht entscheidet grundsätzlich im schriftlichen Verfahren.
...
(2) Einstweilige Anordnungen sind zulässig, wenn die Gefahr besteht dass
...
(8) Eine Abschrift der zu veröffentlichenden Urteilsfassung ist dem
...
(2) Das Gericht kann bei laufenden Verfahren, bei denen es ein
